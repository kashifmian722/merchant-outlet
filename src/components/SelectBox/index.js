...
const sizes = {
  sm: "lg:pb-[10px] xl:pb-[13px] pb-[15px] 3xl:pb-[18px] lg:pt-[12px] xl:pt-[16px] pt-[18px] 3xl:pt-[21px] lg:px-[10px] xl:px-[13px] px-[15px] 3xl:px-[18px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#90e0ef",
              "&:hover": { backgroundColor: "#90e0ef", color: "#000000" },
            }),
