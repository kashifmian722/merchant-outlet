    ...
    <>
      <Column className="bg-cyan_51 font-poppins items-center justify-start mx-[auto] shadow-bs2 w-[100%]">
        <Row className="items-center justify-between w-[97%]">
          <Sidebar
            className="w-[16%]"
            onrowcalendarClick={handleNavigate2}
            onrowinfoClick={handleNavigate3}
            onrowmobileClick={handleNavigate4}
          />
          <Column className="font-inter w-[81%]">
            ...
            <Stack className="lg:h-[444px] xl:h-[555px] 2xl:h-[624px] 3xl:h-[749px] lg:mr-[18px] xl:mr-[23px] 2xl:mr-[26px] 3xl:mr-[31px] lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[98%]">
              <Column className="absolute items-center justify-start lg:pb-[20px] xl:pb-[25px] 2xl:pb-[29px] 3xl:pb-[34px] lg:pl-[20px] xl:pl-[25px] 2xl:pl-[29px] 3xl:pl-[34px] top-[0] w-[100%]">
                <Column className="items-center justify-start mb-[3px] w-[100%]">
                  <Row className="items-center justify-between w-[100%]">
                    ...
                    <Row className="items-center justify-between w-[50%]">
                      <Input
                        value={inputvalue}
                      ...
                      ></Input>
                      <Button
                        className="font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-black_902 text-center w-[21%]"
                      ...
                      <Button
                        className="font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-black_902 text-center w-[18%]"
                        shape="RoundedBorder6"
                        variant="OutlineCyan200"
                      >
                        To
                  ...
                  <Column className="items-center justify-start lg:mt-[14px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] rounded-radius12 w-[100%]">
                    <Row className="items-center justify-evenly pb-[1px] rounded-radius6 w-[100%]">
                      ...
                      <Column className="items-center mb-[1px] w-[31%]">
                        <Text
                          className="bg-cyan_200 font-medium lg:pl-[11px] xl:pl-[14px] 2xl:pl-[16px] 3xl:pl-[19px] lg:pr-[24px] xl:pr-[31px] 2xl:pr-[35px] 3xl:pr-[42px] xl:py-[10px] 2xl:py-[12px] 3xl:py-[14px] lg:py-[8px] text-bluegray_900 w-[333px]"
                          variant="body3"
                        >
                          Description
                        </Text>
                      ...
                      <Column className="items-center w-[12%]">
                        ...
                        <Column className="items-center justify-start lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] w-[26%]">
                      ...
                      <Column className="items-center mt-[1px] w-[12%]">
                        <Text
                          className="bg-cyan_200 font-medium lg:pl-[11px] xl:pl-[14px] 2xl:pl-[16px] 3xl:pl-[19px] lg:pr-[24px] xl:pr-[31px] 2xl:pr-[35px] 3xl:pr-[42px] xl:py-[11px] 2xl:py-[13px] 3xl:py-[15px] lg:py-[9px] text-bluegray_900 w-[133px]"
                          variant="body3"
                        >
                          Price
                        </Text>
                        <Column className="justify-start lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[100%]">
                          <Text
                            className="columnproductcounter"
                            variant="body3"
                          >
                            1700
                          </Text>
                      ...
                      <Column className="w-[12%]">
                        <Text
                          className="bg-cyan_200 font-medium lg:pl-[11px] xl:pl-[14px] 2xl:pl-[16px] 3xl:pl-[19px] lg:pr-[24px] xl:pr-[31px] 2xl:pr-[35px] 3xl:pr-[42px] xl:py-[10px] 2xl:py-[12px] 3xl:py-[14px] lg:py-[8px] text-bluegray_900 w-[133px]"
                          variant="body3"
                        >
                          Ratings
                        </Text>
                        <Column className="items-center justify-start lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] w-[64%]">
                          <Img
              ...
              <Row className="absolute bottom-[0] items-center justify-center left-[5%] w-[25%]">
                <Button
